...
(synth-fun x509_cert () X509Cert
  ...
  ; grammar rules
  (
    (x509_cert X509Cert ((Cert version int validity)))
    (version Version    (V1 V2 V3))
    (validity Validity  ((Validity time time)))
    (time Time          ((UTCTime int int int int int int) (GeneralTime int int int int int int)))

...
(declare-datatype ResourceRecord (
  (Record (NAME DomainName) (TYPE Int) (CLASS Int) (TTL TtlStub) 
...
; 5. Z field is zero'd out
; Encoded directly in the grammar



; 6. Message compression: an entire domain name or list of labels can be replaced with a 2 octet

...
const char *sygus_command_prefix =
    "/Users/lorchrob/Documents/CodeProjects/grammar-based_fuzzing/"
    "SyGuS-fuzzing/CVC4/build/bin/cvc5 --lang=sygus2";
...
const char *build_sygus_command(const char *str1, const char *str2,
                                const char *str3) {
...
int gen_terms(int iterations, const char *sygus_file_dir,
  ...
  const char *sygus_command = build_sygus_command(
      sygus_command_prefix, sygus_file_dir_temp, output_dir);
